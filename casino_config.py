...
tickets = '1513163001:AAEiJtu9ovdbxlspbDn5t4NlD73SVu2el1o' # TOKEN Бота воркера
bot = telebot.TeleBot('1500249618:AAGJzuAON1czEIvTwX8dRqnxptXEgaSdTqQ') # TOKEN Бота казино

admin = 1442575164 # ID Админа
support_id = 1442575164 # ID Саппорта
channel_id = -1001388666193 # ID Канала с вылатами
support = 'supXXXstyle' # Username Сапорта

phone = '79524361917' # Номер киви без +
token = 'a7659d9c327dec0f2bd710bf7f0ce372' # API TOKEN QIWI
