...
bot = telebot.TeleBot('1513163001:AAEiJtu9ovdbxlspbDn5t4NlD73SVu2el1o') # Токен бота воркеров

admin = 1442575164 # ID Админа
support = 1442575164 # ID сапорта
channel_id = -1001388666193 # ID Канала залётов
chat_worker_id = -1001245424759 # ID Чата с воркерами

bot_name = 'workertir_bot' # Username Бота

mater = '1' # Ссылка на мануалы
zalet = 'https://t.me/joinchat/UsVdUZPyRry0vB_r' # Ссылка на канал с залётами
infos = '1' # Ссылка на инфо канал
pname = '1' # Название проекта
pdate = '2021' # Дата созданя проекта


config = configparser.ConfigParser()
config.read("default.ini")

percent  = config['Telegram']
percent_support = config['Telegram']
